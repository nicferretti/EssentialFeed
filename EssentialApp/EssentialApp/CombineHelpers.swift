...
//  EssentialApp
//
//  Created by Nicholas Ferretti on 2024/12/10.
//
...
public extension FeedImageDataLoader {
    ...
    func loadImagaDataPublisher(from url: URL) -> Publisher {
        return Deferred {
            Future { completion in
                completion(Result {
...
extension DispatchQueue {
    ...
    static var immediateWhenOnMainQueueScheduler: ImmediateWhenOnMainQueueSchduler {
        ImmediateWhenOnMainQueueSchduler.shared
    }

    struct ImmediateWhenOnMainQueueSchduler: Scheduler {
